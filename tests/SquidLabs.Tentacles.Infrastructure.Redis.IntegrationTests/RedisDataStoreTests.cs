...
{
    private readonly IClientFactory<TestDataEntry, IRedisOptions<TestDataEntry>, IDatabase> _clientFactory;
    private readonly IDataStore<Guid, TestDataEntry> _dataStore;
    private readonly IOptionsMonitor<IRedisOptions<TestDataEntry>> _redisOptions;
